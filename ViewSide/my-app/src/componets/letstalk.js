...
function TalkCard(props) {
  ...
  return (
    <div
      ...
      className="w-[705px] h-[280px] mt-[60px] ml-[96px] flex flex-col bg-[#2c2d2f] rounded-xl overflow-hidden transition-all duration-500 ease-in-out group hover:bg-[#914bf1]"
    >
